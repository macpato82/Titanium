...
The Softload facility caters for several ROMs, offering a choice
which to use, and remembering the last used.
This requires that before installing this !Boot, any existing ROM
called riscos in your !Boot.Resources.SoftLoad is renamed,
otherwise the new install will overwrite it.
