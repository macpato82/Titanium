...
typedef struct _kernel_languagedescription {
   ...
   char *name;
   PROC (*InitProc)(const struct _kernel_languagedescription *);
   PROC FinaliseProc;
   ...
   void *ctorstart, *ctorend, *dtorstart, *dtorend;
   void (**ctorvecstart)(void), (**ctorvecend)(void);
   void (**dtorvecstart)(void), (**dtorvecend)(void);
